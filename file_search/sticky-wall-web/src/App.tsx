...
// desktop-wall 重開時用 `?floated=<JSON 陣列>` 把「已經是懸浮視窗」的便利貼
// id 帶回來（見 desktop-wall/main.js 的 currentUrl()），讓 floatedIds 初始化
...
export function App() {
  ...
  //
  // 初始值不是固定 null——上次結束程式時如果還在裁切檢視中，desktop-wall
  ...
  const anyDialogOpen = !!dialog || batchCreate || batchDelete || generateNotes || aiSettingsOpen
