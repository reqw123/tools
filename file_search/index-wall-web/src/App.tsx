...
// desktop-wall 重開時用 `?floated=<JSON 陣列>` 把「已經是懸浮視窗」的項目
// path 帶回來（見 desktop-wall/main.js 的 currentUrl()），讓 floatedPaths
...
export function App() {
  ...
  // desktop-wall 專屬手勢——網頁版（沒有 window.desktopWall）完全不會走到
  ...
  const [dialog, setDialog] = useState<'add' | 'import' | 'describe' | 'delete' | 'ai' | null>(null)
